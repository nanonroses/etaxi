        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-xs opacity-90">{t('storeLabels.googlePlay')}</div>
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-xs opacity-90">{t('storeLabels.appStore')}</div>
            ...
            >
              ...
              <span className="text-gray-600">{t('ratingText')}</span>
            </m.div>
          </m.div>
